...
public class ToolDatabase {
     ...
     * 将构造方法私有化
     * */
    private ToolDatabase(Context context) {
        WeatherDatabaseHelper helper = new WeatherDatabaseHelper(context,DB_NAME,null,VERSION);
     ...
     * 获取ToolDatabase的实例
     * */
    public synchronized static ToolDatabase getInstance(Context context){
